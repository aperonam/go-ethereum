...
// UpdateMultihash performs the same action as Update, but stores the data as a multihash type
// The update will be recognized as type multihash upon later retrieval
